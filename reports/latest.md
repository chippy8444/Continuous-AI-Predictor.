# RA Signal Agent Report — 2026-06-05
...
| `gdelt_copper_lithium_shortage_watch` | critical_minerals | ok | alert | 70 | GDELT query=("copper shortage" OR "lithium deficit" OR "critical minerals shortage" OR "battery minerals shortage") timespan=7d |
